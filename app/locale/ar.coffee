...
#    compete: "Compete!" # Course details page
    ...
    change_hero_or_language: "غير البطل أو اللّغة"
    buy_gems: "شراء الأحجار الكريمة"
    subscribers_only: "! المشتركين فقط"
    subscribe_unlock: " !اشترك لتفتح"
#    subscriber_heroes: "Subscribe today to immediately unlock Amara, Hushbaum, and Hattori!"
    subscriber_gems: "! اشترك الآن لتتمكن من شراء هذا البطل بواسطة المجوهرات"
    ...
    brain_pop_done: "! تمكنت من هزيمة الغيلان بواسطة برنامجك ! لقد فزت "
    brain_pop_challenge: "! تحدّى نفسك للعب مرة أخرى بإستعمال لغة برمجة مختلفة"
    replay: "إعادة اللّعب"
    back_to_classroom: "الرجوع للحصة"
    teacher_button: "خاص بالمعلّمين"
#    get_more_codecombat: "Get More CodeCombat"

  code:
    if: "إذا كان" # Keywords--these translations show up on hover, so please translate them all, even if it's kind of long. (In the code editor, they will still be in English.)
    else: "else"
    elif: "else if"
    while: "ما دام"
#    loop: "loop"
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    complete_subscription: "اكمال التسجيل"
#    create_student_header: "إنشاء حساب طالب"
#    create_teacher_header: "إنشاء حساب معلم"
#    create_individual_header: "إنشاء حساب خاص"
    email_announcements: "تلقي الإعلانات عن طريق البريد الإلكتروني"
    sign_in_to_continue: "سجل دخولك او انشئ حسابا لتكمل"
...
#    continue_reading_blog: "Continue Reading on Blog..."
  ...
  loading_error:
    could_not_load: "خطأ في تحميل من الخادم" # {change}
